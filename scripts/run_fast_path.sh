...
# ALL_CLIENTS="-c 500 -c 700 -c 1000"
# ALL_CLIENTS="-c 1200"

start_time=$(date -Ins)
# start_time='2024-10-30T20:35:31.196252+00:00'
RUN_CMD="python3 scripts/run_remote_client_sweep.py -nt /tmp/local_template.json -ct scripts/local_client_template.json -ips ../nodelist.txt -i ../cluster_key.pem -r 3 -s 120 -up 5 -down 5 $ALL_CLIENTS"
...
python3 scripts/plot_time_range_client_sweep.py \
    ...
    -r 3 -c 3 -l node1 -up 30 -down 5 -o plot.png \
