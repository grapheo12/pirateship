...
RUN_CMD="python3 scripts/run_remote_client_sweep.py -nt /tmp/local_template.json -ct scripts/local_client_template.json -ips ../nodelist.txt -i ../cluster_key.pem -r 2 -s 120 -up 5 -down 5 $ALL_CLIENTS"
...
python3 scripts/plot_time_range_client_sweep.py \
    ...
    -r 2 -c 3 -l node1 -up 55 -down 5 -o plot.png \
